    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto " href=" {{URL::asset('assets/img/map.jpeg')}}" target="_blank">Distributeures</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <p><img src="{{URL::asset('assets/img/logo.png')}}"></p>
             <!-- <p>Route de Sousse Km 4 <br>
                Mégrine Riadh - 2014 <br>
                TUNISIA <br>
                <strong>Tel:</strong>+216 26 793 568 <br>
